...
import styles from "assets/jss/react-core/components/headerLinksStyle";
...
export default function HeaderLinks(props) {
  ...
  return (
    <List className={classes.list + " " + classes.mlAuto}>
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          dropdownList={[
            ...
            <a
              href="https://demos.weenspace.com/react-core/#/documentation/tutorial?ref=mkpr-navbar"
              target="_blank"
      ...
      <ListItem className={classes.listItem}>
        <Button
          href="https://www.weenspace.com/product/react-core?ref=mkpr-navbar"
