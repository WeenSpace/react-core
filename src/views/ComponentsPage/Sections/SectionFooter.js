...
import styles from "assets/jss/react-core/views/componentsSections/footerStyle";
          ...
          content={
            <div>
              <div className={classes.left}>
                <a
                  href="https://www.weenspace.com/product/react-core?ref=mkpr-footer-components"
                  target="_blank"
              ...
              <div className={classes.pullCenter}>
                <List className={classes.list}>
                  <ListItem className={classes.inlineBlock}>
                    <a
                      href="https://www.weenspace.com/?ref=mkpr-footer-components"
                      target="_blank"
                  ...
                  <ListItem className={classes.inlineBlock}>
                    <a
                      href="https://www.weenspace.com/presentation?ref=mkpr-footer-components"
                      target="_blank"
                      className={classes.block}
                    >
                      About us
                  ...
                  <ListItem className={classes.inlineBlock}>
                    <a
                      href="https://www.weenspace.com/license?ref=mkpr-footer-components"
                      target="_blank"
                      className={classes.block}
                    >
                      Licenses
            ...
            <div>
              ...
              <div className={classes.pullCenter}>
                <List className={classes.list}>
                  <ListItem className={classes.inlineBlock}>
                    <a
                      href="http://blog.weenspace.com/?ref=mkpr-footer-components"
                      target="_blank"
                      className={classes.block}
                    >
                      Blog
                  ...
                  <ListItem className={classes.inlineBlock}>
                    <a
                      href="https://www.weenspace.com/contact-us?ref=mkpr-footer-components"
                      target="_blank"
                      className={classes.block}
                    >
                      Contact us
        ...
        >
          <GridContainer>
            <GridItem xs={12} sm={4} md={4}>
              <h5>About Us</h5>
              <p>
                WeenSpace is a startup that creates design tools that make
