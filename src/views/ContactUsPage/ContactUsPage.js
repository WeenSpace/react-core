...
import contactUsStyle from "assets/jss/react-core/views/contactUsStyle";
...
const CustomSkinMap = () => {
  ...
  React.useEffect(() => {
    ...
    const contentString =
      '<div class="info-window-content"><h2>React Core</h2>' +
            ...
            <GridContainer>
              ...
              <GridItem md={4} sm={4} className={classes.mlAuto}>
                ...
                <InfoArea
                  ...
                  description={
                    <p>
                      WeenSpace Ltd. <br /> VAT · EN2341241 <br /> IBAN ·
            ...
            <div className={classes.left}>
              <List className={classes.list}>
                <ListItem className={classes.inlineBlock}>
                  <a
                    href="https://www.weenspace.com/?ref=mkpr-contact-us"
                    target="_blank"
                ...
                <ListItem className={classes.inlineBlock}>
                  <a
                    href="https://www.weenspace.com/presentation?ref=mkpr-contact-us"
                    target="_blank"
                    className={classes.block}
                  >
                    About us
                ...
                <ListItem className={classes.inlineBlock}>
                  <a
                    href="https://www.weenspace.com/license?ref=mkpr-contact-us"
                    target="_blank"
                    className={classes.block}
                  >
                    Licenses
