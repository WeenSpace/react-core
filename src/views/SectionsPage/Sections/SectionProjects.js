...
import projectsStyle from "assets/jss/react-core/views/sectionsSections/projectsStyle";
          ...
          <GridContainer>
            <GridItem xs={12} sm={4} md={4}>
              <Card plain className={classes.card2}>
                <a
                  href="https://www.weenspace.com/product/material-kit-react?ref=mkpr-projects-section-sections"
                  target="_blank"
                >
            ...
            <GridItem xs={12} sm={4} md={4}>
              <Card plain className={classes.card2}>
                <a
                  href="https://www.weenspace.com/product/light-bootstrap-dashboard-pro-react?ref=mkpr-projects-section-sections"
                  target="_blank"
                >
                  <CardHeader image plain>
                    <img
            ...
            <GridItem xs={12} sm={4} md={4}>
              <Card plain className={classes.card2}>
                <a
                  href="https://www.weenspace.com/product/now-ui-dashboard-pro-react?ref=mkpr-projects-section-sections"
                  target="_blank"
                >
                  <CardHeader image plain>
                    <img
                ...
                <CardBody plain>
                  ...
                  >
                    ...
                    designed by Invision and coded by WeenSpace. It is built
